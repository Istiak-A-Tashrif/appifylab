// Small shared icon components extracted from the original markup.
// Kept separate so PostCard / Header / dropdowns don't repeat huge inline SVGs.
...
export const VideoIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
    <path
      fill="#666"
      d="M11.485 4.5c2.213 0 3.753 1.534 3.917 3.784l2.418-1.082c1.047-.468 2.188.327 2.271 1.533l.005.141v6.64c0 1.237-1.103 2.093-2.155 1.72l-.121-.047-2.418-1.083c-.164 2.25-1.708 3.785-3.917 3.785H5.76c-2.343 0-3.932-1.72-3.932-4.188V8.688c0-2.47 1.589-4.188 3.932-4.188h5.726zM18.4 8.57l-.062.02-2.921 1.306v4.596l2.921 1.307c.165.073.343-.036.38-.215l.008-.07V8.876c0-.195-.16-.334-.326-.305z"
    />
  </svg>
);
...
export const ArticleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none" viewBox="0 0 18 20">
    <path
      fill="#666"
      d="M12.49 0c2.92 0 4.665 1.92 4.693 5.132v9.659c0 3.257-1.75 5.209-4.693 5.209H5.434c-.377 0-.734-.032-1.07-.095l-.2-.041C2 19.371.74 17.555.74 14.791V5.209c0-.334.019-.654.055-.96C1.114 1.564 2.799 0 5.434 0h7.056zm-.239 12.053H5.656c-.36 0-.652.324-.652.724 0 .4.293.724.652.724h6.587c.36 0 .652-.324.652-.724 0-.4-.292-.724-.652-.724zm0-4.239H5.656c-.334.041-.587.355-.587.729s.253.688.587.729h6.587a.643.643 0 00.632-.339.806.806 0 000-.78.643.643 0 00-.632-.339zM8.17 5.042H5.665c-.336.041-.589.355-.589.728 0 .374.253.688.589.729H8.17c.335-.041.588-.355.588-.729 0-.373-.253-.687-.588-.728z"
    />
  </svg>
);
...
export const ImageAttachIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16">
    <path
      ...
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10.867 1.333c2.257 0 3.774 1.581 3.774 3.933v5.435c0 2.352-1.517 3.932-3.774 3.932H5.101c-2.254 0-3.767-1.58-3.767-3.932V5.266c0-2.352 1.513-3.933 3.767-3.933h5.766zm.426 5.733a1.618 1.618 0 00-1.19-.363 1.618 1.618 0 00-1.098.584L7.486 9.13c-.179.176-.468.172-.646-.008l-.639-.647c-.575-.54-1.485-.513-2.025.06l-1.018 1.075a.499.499 0 00.018.706.498.498 0 00.707-.018l1.02-1.076c.164-.174.44-.183.594-.04.01.012.63.642.63.642a1.456 1.456 0 002.057.021c.026-.025.044-.041 1.594-1.922a.622.622 0 01.421-.225.614.614 0 01.433.118c.097.094 1.836 1.815 1.836 1.815a.5.5 0 00.716-.697c-.99-1.017-1.323-1.357-1.443-1.477zM5.706 4.42c-.92 0-1.67.75-1.67 1.67 0 .92.75 1.67 1.67 1.67.92 0 1.67-.75 1.67-1.67 0-.92-.75-1.67-1.67-1.67z"
    />
  </svg>
);
...
export const ThemeMoonIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="11" height="16" fill="none" viewBox="0 0 11 16">
    <path
      fill="#fff"
      d="M2.727 14.977l.04-.498-.04.498zm-1.72-.49l.489-.11-.489.11zM3.232 1.212L3.514.8l-.282.413zM9.792 8a6.5 6.5 0 00-6.5-6.5v-1a7.5 7.5 0 017.5 7.5h-1zm-6.5 6.5a6.5 6.5 0 006.5-6.5h1a7.5 7.5 0 01-7.5 7.5v-1zm-.525-.02c.173.013.348.02.525.02v1c-.204 0-.405-.008-.605-.024l.08-.997z"
    />
  </svg>
);
